 ...
 */
package ec.edu.espoch.sga.accesodatos;
...
public final class Global {
    ...
    java.util.ResourceBundle Configuracion = java.util.ResourceBundle.getBundle("ec.edu.espoch.sgc.accesodatos.database",lt);
